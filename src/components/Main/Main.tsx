...
const Main: React.FC = () => {
    return (
        ...
        <div className="grid grid-cols-12 py-1 pr-3 items-center bg-emerald-200 text-sm text-gray-500 md:text-base lg:text-lg rounded-lg shadow-md">
            ...
            <i className="hidden md:block col-start-2 text-sm md:text-xl lg:text-2xl material-icons">archive</i>
            <i className="hidden md:block col-span-1 text-sm md:text-xl lg:text-2xl material-icons">delete</i>
            </div>
        </div>
        <Routes>
