import { CREATE_NOTE, UPDATE_NOTE, REMOVE_NOTE, CREATE_CATEGORY, UPDATE_CATEGORY, REMOVE_CATEGORY, SHOW_ACTIVE, SHOW_ARCHIVED, TOGGLE_ACTIVE_NOTE } from "./types"
interface noteIn {
    id: number;
    name: string;
    created: string;
...
export function noteRemove(id: number) {
    return {
        type: REMOVE_NOTE,
        id
    }
...
export function toggleActiveNote(id: number) {
    return {
